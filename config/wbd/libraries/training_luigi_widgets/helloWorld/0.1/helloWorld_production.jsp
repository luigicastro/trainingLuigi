...
<%@page import="tooltwist.training_luigi.productionHelpers.HelloWorldProductionHelper"%>
...
<!-- ********** INSERT HTML HERE ********** -->
<div %%idDefinition%% class="HelloWorld" style="width:200px; border-style:solid; border-width:1px; text-align: center;">
	helloWorld

	<!-- Display an image 
	<img src="%%URL(training_luigi/images/myImage.png)%%"/>
	 -->
