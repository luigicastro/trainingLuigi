package tooltwist.training_luigi.productionHelpers;
...
public class HelloWorldProductionHelper extends WbdProductionHelper
{
	...
	public HelloWorldProductionHelper(Properties prop)
	{
		super(prop);
	}
