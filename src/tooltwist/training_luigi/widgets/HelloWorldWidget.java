package tooltwist.training_luigi.widgets;
...
import tooltwist.training_luigi.productionHelpers.HelloWorldProductionHelper;
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "helloWorld_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "helloWorld_jsHeader.js"),
